...
updater = Updater(token='ENTER_TOKEN_HERE', use_context=True)
...
def start(update, context):
    context.bot.send_message(chat_id=update.effective_chat.id, text="Hello I am one of otwani's bots !")
    context.bot.send_message(chat_id=update.effective_chat.id, text="I can tell you the number of forks from the repository of rahulotwani")
...
def echo(update, context):
    ...
    response = requests.get("https://api.github.com/users/rahulotwani/repos")
